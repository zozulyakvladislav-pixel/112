...
def run_gui() -> None:
    ...
    mode_box = ttk.Combobox(controls, textvariable=mode_var, values=list(PROFILE_PRESETS.keys()), width=18)
    ...
    ttk.Button(controls, text="Analyze PC", command=refresh).pack(side="left", padx=6)
    ttk.Button(controls, text="Export CFG", command=export_cfg_gui).pack(side="left", padx=6)
...
def main() -> None:
    ...
    parser.add_argument("--gui", action="store_true", help="Open simple desktop GUI (Tkinter)")
